...
- Added new ID type (cryptoID) which doesn't persist, but is generated by symmetric encrypton from other persistent id type
- bulk api allow to add multiple patients asynchronously
