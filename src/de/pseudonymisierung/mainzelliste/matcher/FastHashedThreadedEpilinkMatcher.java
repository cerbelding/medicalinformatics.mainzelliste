...
/**
 * Represent a multithreaded version of the FastHashedEpilinkMatcher. The content
 * correspond to the ThreadedEpilinkMatcher. However, it is the optimized
 * version of the exchange groups contained. Whether two patients are compared
 * by their attributes, depends on the comparison of their hashes.
 *
 * For using this Matcher, a threshold must be specified in the configuration
 * file. If no Hasher is specified, the behaviour is like the FastEpilinkMatcher.
 */
public class FastHashedThreadedEpilinkMatcher extends FastHashedEpilinkMatcher {
