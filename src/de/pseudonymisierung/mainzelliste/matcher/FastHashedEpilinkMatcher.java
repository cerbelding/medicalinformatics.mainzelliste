 ...
 * EpilinkFastMatcher, which used the optimized exchange groups. Whether two
 * patients are compared by their attributes, depends on a comparison of their
 * hashes.
 * 
 ...
 */
public class FastHashedEpilinkMatcher extends FastEpilinkMatcher
{
    /** Specified Threshold */
    ...
    /**
     * Returns an instance of the used Hasher. If no Hasher is specified, NULL is returned.
     * 
     * @return Instance of the Hasher or NULL, if no Hasher specified.
     */
