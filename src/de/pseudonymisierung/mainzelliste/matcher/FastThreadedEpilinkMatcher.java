...
/**
 * Represent a multithreaded version of the FastEpilinkMatcher. The content
 * correspond to the ThreadedEpilinkMatcher. However, it is the optimized
 * version of the exchange groups contained.
 */
public class FastThreadedEpilinkMatcher extends FastEpilinkMatcher {
